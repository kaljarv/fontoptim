# AUTOGENERATED! DO NOT EDIT! File to edit: 02_first_letter_and_optim_tests.ipynb (unless otherwise specified).

__all__ = ['SansSerifFontARL', 'DEFAULT_FONT_PARAM_SPECS', 'LETTERS_CROP_BOTH', 'LETTERS_CROP_TOP_ONLY',
